...
public:
    ...
    static double calculateCorrelation(const std::vector<Complex> &residual, double carrier_freq, double carrier_phase,
                                double carrier_amp, double mod_index, double lfo_freq, double lfo_index, size_t N);
    ...
    static std::vector<CleanDFT::Component> deconvolveParallelDirichlet(const std::vector<Complex> &fft, size_t sample_rate,
                                                                 size_t num_threads);
    ...
    static double computeGradient(const std::vector<Complex> &residual, size_t N, double carrier_freq, double carrier_phase,
                                  double carrier_amp, double mod_index, double lfo_freq, double lfo_index,
                                  const std::string &param_name);

    static void addCombinedModulators(std::vector<Complex> &spectrum, size_t N, double carrier_freq, double carrier_phase,
                                      double carrier_amp, double mod_index, double lfo_freq, double lfo_index);
    ...
    static void printProgress(size_t component_count, double carrier_freq, int peak_bin,
                              ...
                              double lfo_freq, double lfo_index, const std::vector<Complex> &residual, double total_energy);
